...
export const pricingPackages = [
  {
    ...
    price: 49,
    description:
      "Perfect for individuals and new businesses looking to establish a professional online presence quickly.",
    features: [
  ...
  },
  {
    ...
    price: 99,
    description:
      "Ideal for growing businesses that need more space to detail their services and engage with customers.",
    features: [
  ...
  },
  {
    ...
    price: 199,
    description:
      "The ultimate solution for startups ready to launch a powerful, data-driven web application.",
    features: [
  ...
  return (
    <section id="pricing" className="container py-24 sm:py-32">
      ...
      <p className="md:w-3/4 mx-auto mt-4 mb-8 text-xl text-muted-foreground text-center">
        We believe every great idea deserves a great website. Start your digital
        journey with our transparent and budget-friendly packages.
      </p>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {pricingPackages.map((pkg) => (
          ...
          >
            ...
            <CardFooter>
              <Button className="w-full" onClick={() => onChoosePackage(pkg)}>
                {pkg.cta}
              </Button>
            </CardFooter>
          </Card>
